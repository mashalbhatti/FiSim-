    ...
    public static class Config {
        ...
        public static string WindowTitle {
            get {
                switch (Mode) {
                    case RunMode.Demo:
                        return "FiSim - Extended Version"; //Changing the name for the extended version 
                    
                    case RunMode.Minimal:
                        return "Riscure BootSim - Extended Version (training edition)";
                    
                    case RunMode.Full:
                        return "Riscure FiSim - Extended Version (training edition)";

...
namespace PlatformSim {
    public class Simulator {
        ...
        public (Result, Trace) TraceSimulation2(IEnumerable<TraceRange> traceRanges = null) {
            ...
            engine.Config.OnCodeExecutionTraceEvent = eng => {
                ...
                Console.WriteLine("Instruction Count: "+ traceData.InstructionTrace.Count); 
                Console.WriteLine("Instruction: " + instruction.ToString()); 
            };

            //Console.WriteLine("Something");
            Console.WriteLine(traceData.InstructionTrace.Count); 
            ...
            {
                Console.WriteLine("Cannot Run Engine!");
        ...
        protected IPlatformEngine CreateEngine() {
            ...
            //Console.WriteLine(Config.Platform); 

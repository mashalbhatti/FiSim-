...
namespace BinInfo {
    public static class BinInfoFactory {
        public static IBinInfo GetBinInfo(string filePath) {
            ...
            if (fileData.Length > 4 && fileData[0] == 0x7F && fileData[1] == 0x45 && fileData[2] == 0x4C && fileData[3] == 0x46 && fileData[0x12] == 0x28) { 
                // aarch32
            ...
            //else if (fileData.Length > 4 && fileData[0] == 0x7F && fileData[1] == 0x45 && fileData[2] == 0x4C && fileData[3] == 0x46 && fileData[0x12] == 0xb7)
            //{
            //    // aarch64
            //    string toolchainFolder;
            ...
            //} 
                ...
                if (PathUtils.ExistsOnPath("aarch64-linux-gnu")) {
                    toolchainFolder = PathUtils.GetFullPath("aarch64-linux-gnu");
                }
                else if (Directory.Exists("toolchains")) {
                    toolchainFolder = "toolchains/aarch64-linux-gnu";
                }

                else {
                    toolchainFolder = "../../../toolchains/aarch64-linux-gnu/bin";
                }
                
                toolchainFolder = Path.GetFullPath(toolchainFolder);
                
                return new ELFBinInfo(ELFType.Aarch64, filePath, toolchainFolder, "aarch64-linux-gnu-");
            } 
            else {
                //string toolchainFolder = "../../../toolchains/MinGW/bin"; 
                //return new ELFBinInfo(ELFType.Aarch64, filePath, toolchainFolder, "");
